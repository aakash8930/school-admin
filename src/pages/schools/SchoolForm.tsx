...
export function SchoolForm({ onClose }: Props) {
  ...
  if (invite) {
    return (
      <Drawer title="School created" onClose={onClose}>
        <div className="space-y-4 px-6 py-5">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-500">
              The link was emailed to the admin — shown here too in case you
  ...
  return (
    <Drawer
      title="New school"
      subtitle="Creating a school also creates its admin login."
      onClose={onClose}
    >
